...
> Shared conventions (metadata format, naming rules, 365 Principle overview, link format) are defined in `manage-docs`.
...
- `00_ROADMAP.md` — Now/Next/Later 전략 (Layer 3 기술 명세 링크 필수)
- `01_BACKLOG.md` — Kanban 보드 (Current / Upcoming / Completed)
...
- **plan-docs**: Layer 1-2 기획/디자인 문서 작성
- **dev-conventions**: 코딩 컨벤션 및 개발 설정 규칙 적용 (문서화가 아닌 코드 작성 시)
